...
{       
      ...
      $('#Interventionreparateur').change(function(){
        ...
        if(etatintervention == 'OUI'){
          ...
          if(etatcltr == '1'){
            alert("Veuillez changer la Valeur du champ Intervention du technicien en 'NON' svp !");
            $('#numscellepompe').prop('readonly', true);
            $('.groupresultApresInt').hide(0);
            $('#numscellemoteur').prop('readonly', false);
            $('#numvignettepompe').prop('readonly', false);
      ...
      if(idProfildet ==2) {
              ...
              jQuery('#fieldImportantnumcomptec').attr('style', 'display:inline; color:red');
              jQuery('#warn_field_profil').attr('style', 'display:none;color:red;');
              jQuery('#fieldImportantraisonsoc').attr('style', 'display:inline; color:red');
      ...
      jQuery("#cellulaire2").blur(function() {
        ...
        if (jQuery.trim(jQuery("#cellulaire2").val())) {
          jQuery('#warn_field_celldetenteur').attr('style', 'display:none;color:red');
        }
         else{
          jQuery('#warn_field_celldetenteur').attr('style', 'display:block;color:red');
         }
      });
      ...
      jQuery("#localisation").blur(function() {
        ...
        if (jQuery.trim(jQuery("#localisation").val())) {
          jQuery('#warn_field_localisation').attr('style', 'display:none;color:red');
        }
         else{
          jQuery('#warn_field_localisation').attr('style', 'display:block;color:red');
         }
      });
      ...
      jQuery("#saveDetenteur").click(function(){
        ...
        if(Profildetenteur == 2){
          ...
          var cellulaire1 =  jQuery("#cellulaire1").val();
            if((cellulaire1) == ''){
            jQuery('#warn_field_cellrespo').attr('style', 'display:block;color:red;');
            //alert("Veuillez sélectionner une structure SVP !!! ");
            checkedform = 0;
          }
        ...
        if(checkedform==0){
          alert("Attention ! un ou plusieurs champs obligatoires ne sont pas renseignés !!!");
      ...
      function selectElmntRowsbyIDTypeElmnt(valtypeelmntcontrl){
        ...
        //alert(JSON.stringify(data));
          ...
          $("#Elmntacontroler").append('<option class="resltOption" value="'+iid_element+'" label="'+iilib_element+'">'+iilib_element+' </option>');        
      ...
      $('#Typeverifcontrole').change(function(){
        ...
        if(valelemntselected!='vide'){
          ...
          alert('veuillez svp sélectionnez le champ ELEMENT A CONTROLER avant celui-ci !');
        }
